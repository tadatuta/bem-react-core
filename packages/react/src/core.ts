...
export type Mods = Record<ModifierName, ModifierValue | boolean>;
...
const stringify = bemjsonStringify(react);

export class Anb<P = {}, S = {}> extends React.Component<P, S> {
...
export class Bem<P, S = {}> extends Anb<BemProps & Attrs<P>, S> {
    ...
    public render() {
        ...
        return React.createElement(tag as 'div', {
...
export class Block<P = {}, S = {}> extends Anb<EntityProps<P>, S> {
    ...
    private prerender() {
        ...
        return React.createElement(this.tag(props, state), Object.assign({}, {
            ...cleanBemProps(this.props),
...
export const withMods: IWithModsSignature = function(Base: AnyEntity, ...modDecls: ModDecl[]) {
    return function modsHoc(props: EntityProps) {
        ...
        return React.createElement(mergedComponent as FullEntity, props);
    };
};
