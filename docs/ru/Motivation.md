...
Стоит заметить, что библиотека невелика по размеру и была создана в [Яндексе](https://yandex.ru/company/) с целью решить ряд проблем, связанных с разработкой крупномасштабных сайтов на React.
...
Проблема с JSX начинается тогда, когда нужна более тонкая настройка. Например, может понадобиться динамически изменить тег JSX-элемента или добавить новое свойство. 

Решить эти задачи можно, например, так: 
